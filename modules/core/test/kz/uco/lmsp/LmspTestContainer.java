...
public class LmspTestContainer extends TestContainer {

    public LmspTestContainer() {
        super();
    ...
    public static class Common extends LmspTestContainer {

        public static final LmspTestContainer.Common INSTANCE = new LmspTestContainer.Common();
